...
def showAllVirNwsSwitchingEnergyImage( key_1, key_2, limits, xlimits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	...
	ax1.plot(timing_1, values_1,label='NVE#1:2',marker='o', markersize=0, color='b' , linewidth='2')
	ax1.plot(timing_2, values_2,label='NVE#1:2+eE+20%',marker='o', markersize=0, color='g' , linewidth='2')
	ax1.plot(timing_3, values_3,label='NVE#1:2+eE+30%',marker='o', markersize=0, color='r' , linewidth='2')
	ax1.plot(timing_4, values_4,label='NVE#1:2+eE+40%',marker='o', markersize=0, color='c' , linewidth='2')
	ax1.plot(timing_5, values_5,label='NVE#1:2+eE+50%',marker='o', markersize=0, color='m', linewidth='2')
	...
	ax2.plot(timing_1, data_volume, label='TrafficVolume', linestyle='solid', linewidth='3', marker='o', markersize=0, color='y')
