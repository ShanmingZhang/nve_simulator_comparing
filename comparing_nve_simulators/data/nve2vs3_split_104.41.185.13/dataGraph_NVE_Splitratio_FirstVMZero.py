...
subname = '2017-05-1808:08:17_recordsOutput.json'

dirname = './nve2vs3_split_104.41.185.13/'
...
def showCurrentInfoImage( key, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	...
	plt.plot(timing_1, values_1,label='NVE#2-No-Split', color='b' )
	...
	plt.savefig(dirname + 'current_'+ title + '.png')
	plt.close()
...
def showAllAcceptionRatioImage( key_1, key_2, limits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	...
	plt.plot(timing_1, values_1,label='NVE#2-No-Split',marker='o', markersize=0, color='b' )
...
def showTwoAcceptionRatioImage( key_1, key_2, limits, record_1, record_2, ytxt, xtxt, title, ratio):
	...
	plt.savefig(dirname + title + '_' + ratio + '.png')
	plt.close()
...
# key_1 : AmountVirNws or AvailableVirNws
showEmbeddingVirNwsImage('AmountVirNws', 2, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5, 'Virtual Network(s)','Time Unit(s)','Evaluation of Embedded Virtual Network(s)' )

showEmbeddingVirNwsImage('AvailableVirNws', 2, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5, 'Virtual Network(s)','Time Unit(s)','Evaluation of Available Virtual Network(s)' )

showEmbeddingVirNwsImage('CurrentEndingVirNws', 2, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5, 'Virtual Network(s)','Time Unit(s)','Evaluation of Ending Virtual Network(s)' )
...
flag = 1
showAllSubstrateLinkResoruceStatusImage( 'CurrentSubLinkResourceMinInfo', flag, limits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Substrate Link(s)', 'Time Unit(s)', 'Evaluation of Substrate Embeddale Link Resoruce (Less than 30M)')

flag = 2
showAllSubstrateLinkResoruceStatusImage( 'CurrentSubLinkResourceMaxInfo', flag,limits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Substrate Link(s)', 'Time Unit(s)', 'Evaluation of Substrate Embeddale Link Resoruce (More than 100M)')

flag = 3
showAllSubstrateLinkResoruceStatusImage( 'EmbeddableSubLinkResourceInfo', flag, limits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Substrate Link(s)', 'Time Unit(s)', 'Evaluation of Substrate Embeddale Link Resoruce (Among 30M to 100M)')
