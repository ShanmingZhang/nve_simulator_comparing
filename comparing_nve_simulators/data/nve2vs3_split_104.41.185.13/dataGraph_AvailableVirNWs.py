...
# 
def showAllAcceptionRatioImage_3( key_1, key_2, key_3, limits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	timing_1 = []
	timing_2 = []
	timing_3 = []
	timing_4 = []
...
#CurrentSameVirNws
	...
	ax1.plot(ax1.get_xticks(), data_volume_0, label='VNRequests', linestyle='solid', linewidth=1, marker='o', markersize=4, color='y')
	ax1.plot(ax1.get_xticks(), data_volume_10, label='SameVNs', linestyle='solid', linewidth=1, marker='o', markersize=4, color='k')
	ax1.plot(ax1.get_xticks(), data_volume_1, linestyle='solid', linewidth=2, marker='o', markersize=5, color='k')
	...
	axes2.set_ylabel('Virtual Network Requests', color='k')
	...
	axes2.yaxis.set_major_locator(ticker.MultipleLocator(10))
...
showAllAcceptionRatioImage_3( 'AvailableVirNws', 'RequestEmbedding', 'CurrentSameVirNws', limits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Available Virtual Networks', 'Time Unit', 'A1 Evaluation of Available Virtual Networks')
