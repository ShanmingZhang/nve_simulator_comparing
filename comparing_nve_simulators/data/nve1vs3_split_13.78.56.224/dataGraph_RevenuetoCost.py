...
def showRevenueToCostRatioImage( key_1, key_2, limits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	timing_1 = []
	timing_2 = []
	timing_3 = []
	timing_4 = []
...
#key_11 = 'SublinkCost'
#Revenue to subcost = Revenue / SubCost
showRevenueToCostRatioImage( 'EmbeddedBandwidth', 'SublinkCost', limits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Ratio', 'Time Unit', 'A3 Evaluation of Virtual Network Revenue To Substrate Cost')
