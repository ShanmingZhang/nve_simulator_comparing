...
#CurrentSameVirNws
	...
	ax1.plot(ax1.get_xticks(), data_volume_0, label='VNRequests', linestyle='solid', linewidth=2, marker='o', markersize=3, color='y')
	ax1.plot(ax1.get_xticks(), data_volume_10, label='SameVNs', linestyle='solid', linewidth=2, marker='o', markersize=3, color='k')
