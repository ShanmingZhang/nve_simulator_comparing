...
public:
	 ...
	 */
	map<string, EndUserRequest*> getAvaliableEndUserRequests(const int timing, map<string, EndUserRequest*> euRequests);
...
private:
	...
	/*
	 * int: timing,
	 * int: current amount of substrate links(embed Bw < 30 M)
	 * int: current amount of substrate links(embed Bw < 100 M)
	 */
