...
const int CommonConstants::VNE_ELAPSED_TIME_UNITS = 86400;  // 24 hours
const int CommonConstants::MIN_VNW_DURATION_TIME_UNITS = 720;  //  one hour 3600
const int CommonConstants::MAX_VNW_DURATION_TIME_UNITS = 1080; // three hours: 10800

const int CommonConstants::VNW_REQUEST_TIME_INTERVAL_UNITS = 25; // time interval : 100 seconds

const int CommonConstants::POISSON_DISTRIBUTION_REQUEST_DATA_RATE = 320; // 320 kb/s translate to Mb/s at applying
const int CommonConstants::POISSON_DISTRIBUTION_REQUEST_AMOUNT_PER_SECOND = 5; // 5 end user request for a virtual network in a time unit

//end-user request duration time from 200s to 1000s , the most is 200 ~ 400 seconds
const int CommonConstants::MIN_END_USER_REQUEST_DURATION_TIME_UNITS = 200; //  one hour
const int CommonConstants::MAX_END_USER_REQUEST_DURATION_TIME_UNITS = 400; // three hours
...
double CommonConstants::DYNAMIC_VIRTUAL_LINK_RESOURCE_ALLOCATION_SPLITTING_RATIO =
