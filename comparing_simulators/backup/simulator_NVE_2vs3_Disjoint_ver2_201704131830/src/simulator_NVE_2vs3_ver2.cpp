...
// place before perform end-user request function
		...
		nve_2->addEndUserVideoRequestIntoRecords(nve_2->getAvaliableEndUserRequests(timing, euRequests_default));
...
//		}
	...
	CommonFunctions::OutputRecordsIntoImageFile("NVE#2", "NVE#3",
			nve_2->getCongestionRecords(), nve_3->getCongestionRecords(),
			nve_2->getAmountVnsRecords(), nve_3->getAmountVnsRecords(),
			nve_2->getCurrentNumberOfVns(), nve_3->getCurrentNumberOfVns(),
			nve_2->getCurrentRevenueVirLinkRecords(),
			nve_3->getCurrentRevenueVirLinkRecords(),
			nve_2->getCurrentRevenueVirNodeRecords(),
			nve_3->getCurrentRevenueVirNodeRecords(),
			nve_2->getDataSwitchingEnergy(), nve_3->getDataSwitchingEnergy(),
			nve_2->getTransportedDataVolume(),
			nve_3->getTransportedDataVolume(),
			...
			nve_2->getCurrentEndingVirNws(), nve_3->getCurrentEndingVirNws(),
			...
			nve_2->getCurrentSameVirNws(), nve_3->getCurrentSameVirNws(),

			nve_2->getCurrentComVirNws(), nve_3->getCurrentComVirNws());
