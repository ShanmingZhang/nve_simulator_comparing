...
subname = '2017-05-2107:07:31_recordsOutput.json'
...
def showAllVirNwsSwitchingEnergyImage( key_1, key_2, limits, xlimits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	timing_1 = []
	timing_2 = []
	timing_3 = []
	timing_4 = []
	...
	ax1.plot(timing_5, data_volume_0,label='TrafficVolume',linestyle='solid', linewidth='2', marker='o', markersize=0, color='y')


	ax1.plot(timing_1, values_1,label='NVE#1:1',marker='o', markersize=0, color='b' , linewidth='2')
	ax1.plot(timing_2, values_2,label='NVE#1:1+eE+20%',marker='o', markersize=0, color='g' , linewidth='2')
	ax1.plot(timing_3, values_3,label='NVE#1:1+eE+30%',marker='o', markersize=0, color='r' , linewidth='2')
	ax1.plot(timing_4, values_4,label='NVE#1:1+eE+40%',marker='o', markersize=0, color='c' , linewidth='2')
	ax1.plot(timing_5, values_5,label='NVE#1:1+eE+50%',marker='o', markersize=0, color='m', linewidth='2')
	


	ax1.set_ylabel(ytxt, fontsize=17)
	...
	#plt.title('(B) Data Switching Energy of Same Virtual Networks', fontsize=17)

	ax2 = ax1.twinx()

	print len(timing_1)
	print len(data_volume)
	ax2.plot(timing_1, data_volume, label='TrafficVolume', linestyle='solid', linewidth='2', marker='o', markersize=0, color='y')
	ax2.set_ylabel('Traffic Volume(Megabits)', fontsize=17)
...
showAllVirNwsSwitchingEnergyImage('SameVirNwDataSwitchingEnergy', 'SameVirNwTransportedDataVolume', limits, xlimits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Switching Energy(Joule)','Time Unit','A5 Evaluation of Same Data Transmission Switching Energy')
## total data swiching energy
