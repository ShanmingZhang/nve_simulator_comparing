...
def showResourceUtilizationImage( key_1, limits, xlimits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	timing_1 = []
	timing_2 = []
	timing_3 = []
	timing_4 = []
	...
	plt.grid(True)
	#plt.title('(F) Substrate Resource Utilization', fontsize=17)
...
#key_11 = 'SublinkCost'
#Revenue to subcost = Revenue / SubCost
showResourceUtilizationImage('SublinkResourceUtilization', limits, xlimits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,  'Utilization','Time Unit','A4 Evaluation of Substrate Link Resource Utilization')
