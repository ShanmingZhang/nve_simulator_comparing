...
# Acceptance Ratio = 1 - FailureEmbedding / RequestEmbedding
def showAllAcceptionRatioImage_3( key_1, key_2, limits, xlimits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	timing_1 = []
	timing_2 = []
	timing_3 = []
	timing_4 = []
	...
	#plt.title('(D) Virtual Network Request Acceptance Rate', fontsize=17)
	#plt.show()
...
showAllAcceptionRatioImage_3( 'FailureEmbedding', 'RequestEmbedding', limits, xlimits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Acceptance Rate', 'Time Unit', 'A2 Evaluation of Virtual Network Request Acceptance Ratio')
