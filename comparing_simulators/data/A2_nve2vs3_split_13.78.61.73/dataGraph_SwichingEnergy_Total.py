...
def showAllVirNwsSwitchingEnergyImage( key_1, key_2, limits, xlimits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	...
	#ax1.plot(timing_5, data_volume_0,label='NVE#2-TrafficVolume',linestyle='solid', linewidth='2', marker='o', markersize=0, color='y')
	...
	#plt.title('(C) Data Swiching Energy of Total Virtual Networks', fontsize=17)

	#ax2 = ax1.twinx()

	print len(timing_1)
	print len(data_volume)
	#ax2.plot(timing_1, data_volume, label='NVE#2-TrafficVolume', linestyle='solid', linewidth='2', marker='o', markersize=0, color='y')
...
showAllVirNwsSwitchingEnergyImage('DataSwichingEnergy', 'TransportedDataVolume', limits, xlimits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Switching Energy(Joule)','Time Unit','A6 Evaluation of Total Data Transmission Switching Energy')
## total data swiching energy
