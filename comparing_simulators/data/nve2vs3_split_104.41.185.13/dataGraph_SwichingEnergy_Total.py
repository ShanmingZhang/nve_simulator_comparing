...
def showAllVirNwsSwitchingEnergyImage( key_1, key_2, limits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	...
	ax1.plot(timing_1, values_1,label='NVE#2-No-Split',marker='o', markersize=0, color='b' )
...
showAllVirNwsSwitchingEnergyImage('DataSwichingEnergy', 'TransportedDataVolume', limits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Switching Energy(Joule)','Time Unit','A6 Evaluation of Total Data Transmission Switching Energy')
## total data swiching energy
