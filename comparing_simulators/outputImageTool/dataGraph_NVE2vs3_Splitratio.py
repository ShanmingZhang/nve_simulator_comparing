...
subname = '2017-04-1619:07:56_recordsOutput.json'


nve_1_file = 'NVE#2_' + subname
...
def showAllAcceptionRatioImage( key_1, key_2, limits, record_1, record_2, record_3, record_4, record_5, ytxt, xtxt, title):
	...
	plt.plot(timing_1, values_1,label='NVE#2-No-Split',marker='o', markersize=3, color='b' )
...
# key_1 : RequestEmbedding
# AccetpionRatio = 1 - FailureEmbedding / RequestEmbedding
showTwoAcceptionRatioImage( 'FailureEmbedding', 'RequestEmbedding', limits, recordJson_1, recordJson_2, 'Accetpion Ratio', 'Time Unit(s)', 'Evaluation of Total Virtual Network Request Accetpion Ratio', '20')

showTwoAcceptionRatioImage( 'FailureEmbedding', 'RequestEmbedding', limits, recordJson_1, recordJson_3, 'Accetpion Ratio', 'Time Unit(s)', 'Evaluation of Total Virtual Network Request Accetpion Ratio', '30')

showTwoAcceptionRatioImage( 'FailureEmbedding', 'RequestEmbedding', limits, recordJson_1, recordJson_4, 'Accetpion Ratio', 'Time Unit(s)', 'Evaluation of Total Virtual Network Request Accetpion Ratio', '40')

showTwoAcceptionRatioImage( 'FailureEmbedding', 'RequestEmbedding', limits, recordJson_1, recordJson_5, 'Accetpion Ratio', 'Time Unit(s)', 'Evaluation of Total Virtual Network Request Accetpion Ratio', '50')


showAllAcceptionRatioImage( 'FailureEmbedding', 'RequestEmbedding', limits, recordJson_1, recordJson_2, recordJson_3, recordJson_4, recordJson_5,'Accetpion Ratio', 'Time Unit(s)', 'Evaluation of Total Virtual Network Request Accetpion Ratio')
